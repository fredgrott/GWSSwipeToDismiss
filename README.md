...
Soft fork of Jake Wharton's SwipeToDismissNOA without the nineoldandroids dependencies.
...
```groovy
compile 'com.github.shareme:GWSSwipeToDismiss:{latest-release-number}@aar'
```
...
[Roman Nurik's gist ](https://gist.github.com/2980593)
